...
pnm = paste0(cfglst$output_dir,"/CMS_Eurasia_JJA_Like_Mean.pdf")
...
pnm = paste0(cfglst$output_dir,"/CMS_Eurasia_JJA_Like_MainA.pdf")
pdf(pnm,width = 9,height=6)
print(gmna)
dev.off()
...
pnm = paste0(cfglst$output_dir,"/CMS_Eurasia_JJA_Like_MainB.pdf")
pdf(pnm,width = 9,height=6)
print(gmnb)
dev.off()
...
pnm = paste0(cfglst$output_dir,"/CMS_Eurasia_JJA_Like_Interact.pdf")
pdf(pnm,width = 9,height=6)
print(gmni)
dev.off()
