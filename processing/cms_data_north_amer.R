...
flxmrg = flxmrg[(flxmrg$Region == 1) | (flxmrg$Region == 2),]
...
nc1 = nc_create("../FunctionalANOVA/Example_CMS_NAmer//CMS_NAmer_Flux.nc",list(varx,vary,vardt,varctrstA,varctrstB,varA,varB))
